...
def conectar(usuario="postgres", password="vdrs2010",
             puerto="5432", nombre_base="sismos", host="localhost"):
    db = psycopg2.connect(database= nombre_base, user=usuario, password=password,
